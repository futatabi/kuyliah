...
//tgl
        ...
        // capture our View elements
        mDateDisplay = (TextView) findViewById(R.id.editharijadwal);
        mPickDate = (EditText) findViewById(R.id.editharijadwal);
// add a click listener to the button
...
//database
        ...
        text1 = (EditText) findViewById(R.id.editnamamatkul);
        text2 = (EditText) findViewById(R.id.editharijadwal);
        text3 = (EditText) findViewById(R.id.editwaktu);
        text4 = (EditText) findViewById(R.id.editruangan);
        text5 = (EditText) findViewById(R.id.editdosen);
        text6 = (EditText) findViewById(R.id.editsks);


        SQLiteDatabase db = dbHelper.getReadableDatabase();
        cursor = db.rawQuery("SELECT * FROM jadwal WHERE namamk = '" +
                getIntent().getStringExtra("namamk") + "'", null);
        cursor.moveToFirst();
        ...
        ton1 = (Button) findViewById(R.id.savejadwal);
        ...
        ton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (text1.getText().toString().trim().equals("")) {
                    text1.setError("Isi Nama Mata Kuliah");

                } else {
                    db.execSQL("REPLACE into jadwal (namamk, tgl, waktu, ruang, dosen, sks) values('" +
    ...
    private void openTimePickerDialog(boolean is24r) {
        ...
        timePickerDialog = new TimePickerDialog(EditJadwal.this,
...
// Month is 0 based so add 1
    ...
    private void setAlarm(Calendar targetCal) {
        ...
        Intent intent = new Intent(getBaseContext(), JadwalReceiver.class);
